...
const getPreviousRange = (range: DateRange): DateRange => {
  ...
  return {
    start: new Date(range.start.getTime() - dur - 1),
          ...
          <div className="space-y-3 pt-1">
            <div>
              ...
              <input
                ...
                className={`w-full text-sm text-neutral-700 bg-neutral-50 border rounded-xl
...
const AnalyticsDashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (timeRange !== 'custom' || !customStartDate || !customEndDate) {
      setRangeError(null); return;
    }
    setRangeError(new Date(customStartDate) > new Date(customEndDate)
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const { data: currOrders, error: currErr } = await supabase
          .from('orders').select(orderSelect)
          ...
          <div className="hidden lg:block w-60 flex-shrink-0 space-y-4">
            <div className="bg-white rounded-xl border border-neutral-200 p-4 animate-pulse space-y-3">
              ...
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="w-full h-10 bg-neutral-100 rounded-xl" />
              ))}
            </div>
          </div>
        ...
        <div className="flex-1 min-w-0 space-y-5">
          ...
          <div className="flex items-center justify-between lg:hidden">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-white border border-neutral-200
          ...
          >
            ...
            <motion.div variants={itemV}
              ...
              <p className="text-sm text-neutral-400 mt-1">Revenue · {periodLabel}</p>
              <div className="mt-4 pt-3 border-t border-neutral-100">
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-100">
                <div>
                  ...
                  <p className="text-xs text-neutral-400 mt-0.5">By revenue · {periodLabel}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-100">
                <div>
                  ...
                  <p className="text-xs text-neutral-400 mt-0.5">Most recent · {periodLabel}</p>
                </div>
                <div className="w-8 h-8 bg-neutral-100 rounded-xl flex items-center justify-center">
